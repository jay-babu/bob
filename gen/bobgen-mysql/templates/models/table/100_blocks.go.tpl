...
{{if not $table.Constraints.Primary -}}
	...
	var {{$tAlias.UpPlural}} = {{$.Dialect}}.NewViewxWithMapper[*{{$tAlias.UpSingular}}, {{$tAlias.UpSingular}}Slice]("{{$table.Name}}", Build{{$tAlias.UpSingular}}Columns({{quote $table.Key}}), {{$tAlias.DownSingular}}ScanMapper)
...
{{- else -}}
	...
	var {{$tAlias.UpPlural}} = {{$.Dialect}}.NewTablexWithMapper[*{{$tAlias.UpSingular}}, {{$tAlias.UpSingular}}Slice, *{{$tAlias.UpSingular}}Setter]("{{$table.Name}}", Build{{$tAlias.UpSingular}}Columns({{quote $table.Key}}), {{$tAlias.DownSingular}}ScanMapper, {{$table.UniqueColPairs}})
