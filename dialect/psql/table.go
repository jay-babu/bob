...
func NewTablexWithMapper[T any, Tslice ~[]T, Tset setter[T], C bob.Expression](schema, table string, columns C, scanner scan.Mapper[T]) *Table[T, Tslice, Tset, C] {
	if scanner == nil {
		panic("psql: nil mapper passed to NewTablexWithMapper")
	}
